...
import numpy as np
from .utils.MBConv import MBConvBlock
from .utils.MHSA import MHSABlock,Mlp
...
def MetaFG_0(cfg, **kwargs):
    ...
    model = MetaFG(conv_embed_dims = [64,96,192],attn_embed_dims=[384,768],
                 conv_depths = [2,2,3],attn_depths = [5,2],num_heads=8,mlp_ratio=4., 
                 drop_path_rate=0.1, img_size=384, only_last_cls=False, 
                 extra_token_num=cfg['extra_token_num'], meta_dims=['meta_dims'], **kwargs)
